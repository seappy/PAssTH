...
type MockOrder = { id: string; distanceM: number };
...
/**
 * Mock map fallback used when no map API key is configured. Positions car
 * markers around the store by distance + a stable per-order bearing.
 */
export function MockMap({ orders }: { orders: MockOrder[] }) {
