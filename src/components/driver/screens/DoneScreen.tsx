...
export default function DoneScreen({ onToPickup }: { onToPickup: () => void }) {
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 30, textAlign: "center", position: "relative" }}>
      ...
      <div style={{ fontSize: 34, fontWeight: 800, color: "#191F28", marginBottom: 10, letterSpacing: "-.02em" }}>매장에 ETA가 전달되었습니다</div>
      ...
      <div style={{ display: "flex", gap: 16, marginBottom: 36 }}>
        <div style={{ background: "#fff", border: "1px solid #EDF0F3", borderRadius: 18, padding: "22px 44px", boxShadow: "0 3px 12px rgba(20,40,80,.04)" }}>
          <div style={{ fontSize: 13, color: "#8B95A1", fontWeight: 600, marginBottom: 8 }}>예상 도착</div>
          <div className="num" style={{ fontSize: 36, fontWeight: 800, color: "#3182F6" }}>14:47</div>
        </div>
        <div style={{ background: "#fff", border: "1px solid #EDF0F3", borderRadius: 18, padding: "22px 44px", boxShadow: "0 3px 12px rgba(20,40,80,.04)" }}>
          <div style={{ fontSize: 13, color: "#8B95A1", fontWeight: 600, marginBottom: 8 }}>주문번호</div>
          <div className="num" style={{ fontSize: 36, fontWeight: 800, color: "#191F28" }}>A-2043</div>
        </div>
      </div>
      <div
        onClick={onToPickup}
